...
import br.com.sigep.apresentacao.aplicacao_spring.financeiro.financeiroMenuController;
...
public class LoginController extends Controller {
    ...
    public void actionLogin(Event e){
        ...
        if (login.equals("atendente")){
            ...
            carregarScene(telaLogin, financeiroMenuController.class); //substituir pelo controller do Dashboard quando for implementado
